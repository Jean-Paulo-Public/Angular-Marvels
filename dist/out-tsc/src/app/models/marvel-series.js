...
export var RatingSeries;
(function (RatingSeries) {
    RatingSeries["Empty"] = "";
    RatingSeries["MarvelPsr"] = "Marvel Psr";
    RatingSeries["RatedT"] = "Rated T";
    RatingSeries["RatingSeriesRatedT"] = "Rated T+";
...
export class Convert {
    static toMarvelSeries(json) {
        return cast(JSON.parse(json), r("MarvelSeries"));
    }
    static marvelSeriesToJson(value) {
...
//# sourceMappingURL=marvel-series.js.map